...
function SettingsModal({ onClose, onResetOffensive, onResetDefensive }: {
  onClose: () => void;
...
function BuffModal({ isFood, onClose, onSelect, items }: {
  isFood: boolean; onClose: () => void; onSelect: (item: EquippedItem) => void;
  items?: EquippedItem[];
}) {
  const [query, setQuery] = useState("");
  const [selected, setSelected] = useState<EquippedItem | null>(null);
